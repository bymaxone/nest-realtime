...
- **Overall progress:** 🔄 5 / 6 phases done (83%) — 63 / 73 tasks (86%)
- **Active phase:** **Phase 6** (Release v0.1.0) — 🔄 In Progress
- **Blocked:** none
...
| 6 | [Release v0.1.0](./tasks/phase-06-release.md) | 🔄 In Progress | 0/10 | LOW | 2026-06-30 |
| | **Total** | 🔄 **5 / 6 phases** | **63 / 73 tasks** | — | — |
